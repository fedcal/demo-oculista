...
hero:
  ...
  actions:
    - theme: brand
      text: Demo live
      link: https://oculista.demo.federicocalo.dev
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/federico-demo-oculista
...
features:
  ...
  - icon: 📊
    ...
    details: Dati Italia 2026 (menu, listini, orari, prezzi medi) curati per il verticale Oculista.
  - icon: 🚀
...
Questo repository contiene il template **Angular 21 SSR** per un sito web professionale per **Oculista** in Italia.
...
Il mercato italiano delle PMI per **Oculista** ha caratteristiche specifiche:
...
```bash
git clone https://github.com/fedcal/federico-demo-oculista.git
cd federico-demo-oculista
npm install
npm start
# → http://localhost:4200
```
...
- [GitHub repo](https://github.com/fedcal/federico-demo-oculista)
