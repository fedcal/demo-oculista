...
URL: `https://oculista.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `oculista.demo.federicocalo.dev`
...
- Output directory: `dist/oculista/browser`
...
URL: `https://fedcal.github.io/federico-demo-oculista/`
...
- `base: /federico-demo-oculista/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `oculista-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   oculista-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `oculista-docs.federicocalo.dev`
