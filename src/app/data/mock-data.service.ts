...
import type { InfoAttivita, ServiziData, ChirurgiaData, Team, Faq } from './types';
...
export class MockDataService {
  ...
  readonly chirurgia$: Observable<ChirurgiaData> = this.http
    .get<ChirurgiaData>('/assets/mock/chirurgia.json')
    .pipe(shareReplay(1));
