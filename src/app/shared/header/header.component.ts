  ...
  template: `
    <header class="site-header">
      <div class="site-header__inner">
        <a routerLink="/" class="brand" aria-label="Home — Centro Oculistico Sguardo">
          <span class="brand__icon" aria-hidden="true">👁️</span>
          <span class="brand__text">Centro Sguardo</span>
        </a>
        <nav class="site-nav" aria-label="Navigazione principale">
          ...
          <a routerLink="/chirurgia" routerLinkActive="is-active">Chirurgia</a>
